  ...
  return (
    <div className='app__about'>
      <div className='app__about-text-container'>
        ...
        <span>In my spare time I enjoy building websites/apps and generally improve my web development skills. At the moment I'm playing with React, Next.js, MongoDB, and TypeScript. </span>
